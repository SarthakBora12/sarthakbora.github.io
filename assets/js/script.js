$(document).ready(function () {
    ...
    $("#contact-form").submit(function (event) {
        emailjs.init("ELaLOpA7eoHAOyHB1");
        
        emailjs.sendForm("service_0ed50zf", "template_z5un06g", '#contact-form')
...
document.addEventListener('visibilitychange',
    function () {
        if (document.visibilityState === "visible") {
            document.title = "Portfolio | Sarthak Bora";
...
// Initialize Typed.js on the element with class "typing-text"
var typed = new Typed(".typing-text", {
    strings: [
        "Statistics and Probability",
        "Deep Learning and Neural Networks",
        "Machine Learning &amp; Algorithm", // Use &amp; instead of &
        "Natural Language Processing",
        "Big Data Technologies",
        "Business Intelligence",
        "Cloud Operations",
        "Time Series Analysis",
        "Hypothesis &amp; A/B Testing" // Again, use &amp; here if needed
    ],
    loop: true,
    typeSpeed: 25,
    backSpeed: 25,
...
//     s1.async = true;
//     s1.src = 'https://tawk.to/chat/647a94867c7b15544f3eb508/1h1vd8bo4';
//     s1.charset = 'UTF-8';
...
// var s1=document.createElement("script"),s0=document.getElementsByTagName("script")[0];
// s1.async=true;
// s1.src='https://embed.tawk.to/659747068d261e1b5f4fcfdb/1hjbijaru';
// s1.charset='UTF-8';
// s1.setAttribute('crossorigin','*');
// s0.parentNode.insertBefore(s1,s0);
// })();
